...
std::pair<std::string, std::string> getCodeFromShaderPath(const char* vertexPath, const char* fragmentPath){
...
Shader::Shader(const char* vertexPath, const char* fragmentPath){
    const auto [vShaderCode, fShaderCode] = getCodeFromShaderPath(vertexPath, fragmentPath);
